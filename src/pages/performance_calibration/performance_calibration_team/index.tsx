...
interface PerformanceCalibrationTeamMember {
  MicrosoftId: string;
  displayName: string;
  email: string;
  jobTitle: string;
...
const PerformanceCalibrationTeam: React.FC = () => {
  const { user, setUser } = useAuth();
  const [members, setMembers] = useState<PerformanceCalibrationTeamMember[]>([]);
...
export default PerformanceCalibrationTeam; 
